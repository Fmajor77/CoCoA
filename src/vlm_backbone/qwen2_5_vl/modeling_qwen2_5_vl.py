...
def apply_rotary_pos_emb_flashatt(tensor: torch.Tensor, freqs: torch.Tensor) -> torch.Tensor:
    ...
    cos = cos.to(tensor_.dtype)
    sin = sin.to(tensor_.dtype)
    output = apply_rotary_emb(tensor_, cos, sin)
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        return model_inputs
class Qwen2_5_VLBidirectionalAttention(Qwen2_5_VLAttention):
    """
    Bidirectional version of Qwen2_5_VLAttention (no causal masking)
    """
    def __init__(self, config: Qwen2_5_VLConfig, layer_idx: Optional[int] = None):
...
class Qwen2_5_VLBidirectionalFlashAttention2(Qwen2_5_VLFlashAttention2):
    """
    Bidirectional version of Qwen2_5_VLFlashAttention2 (no causal masking)
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.is_causal = False
...
class Qwen2_5_VLBidirectionalSdpaAttention(Qwen2_5_VLSdpaAttention):
    """
    Bidirectional version of Qwen2_5_VLSdpaAttention (no causal masking)
    """
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.is_causal = False
...
QWEN2_5_VL_ATTENTION_CLASSES_BIDIRECTIONAL = {
    "eager": Qwen2_5_VLBidirectionalAttention,
    "flash_attention_2": Qwen2_5_VLBidirectionalFlashAttention2,
    "sdpa": Qwen2_5_VLBidirectionalSdpaAttention,
}


class Qwen2_5_VLBidirectionalDecoderLayer(nn.Module):
    """
    ...
    def __init__(self, config: Qwen2_5_VLConfig, layer_idx: int):
        ...
        self.self_attn = QWEN2_5_VL_ATTENTION_CLASSES_BIDIRECTIONAL[config._attn_implementation](
            config, layer_idx
        )
...
class Qwen2_5_VLBidirectionalModel(Qwen2_5_VLPreTrainedModel):
    """
    Qwen2.5-VL Model with bidirectional attention for MNTP training (Stage 1)
    """
    _no_split_modules = ["Qwen2_5_VLBidirectionalDecoderLayer"]
    ...
    def __init__(self, config: Qwen2_5_VLConfig):
        ...
        self.layers = nn.ModuleList(
            [Qwen2_5_VLBidirectionalDecoderLayer(config, layer_idx) 
        ...
        logger.info(f"✓ Initialized Qwen2_5_VLBidirectionalModel with {len(self.layers)} bidirectional layers")
    ...
    def forward(
        ...
        *args, **kwargs
        ...
        causal_mask = self._update_bidirectional_mask(
            attention_mask, inputs_embeds, cache_position, past_key_values, output_attentions
        )
    ...
    def _update_bidirectional_mask(
        self,
        attention_mask: torch.Tensor,
        input_tensor: torch.Tensor,
        cache_position: torch.Tensor,
...
class Qwen2_5_VLForConditionalGenerationBidirectional(Qwen2_5_VLForConditionalGeneration):
    """
    Qwen2.5-VL for MNTP with bidirectional attention (Stage 1)
    """
    def __init__(self, config):
        ...
        self.model = Qwen2_5_VLBidirectionalModel(config)
        ...
        logger.info("✓ Initialized Qwen2_5_VLForConditionalGenerationBidirectional with bidirectional attention")


import warnings

class Qwen2_5_VLBlockAttentionModel(Qwen2_5_VLPreTrainedModel):
    _no_split_modules = ["Qwen2_5_VLBidirectionalDecoderLayer"]
    ...
    def __init__(self, config: Qwen2_5_VLConfig):
        ...
        logger.info(f"✓ Initialized Qwen2_5_VLBlockAttentionModel with attn_implementation='{self._attn_implementation}'")
    ...
    def _validate_and_set_attn_implementation(self, config):
        ...
        if original_impl == "flash_attention_2":
            warnings.warn(
                f"⚠️ Block Attention 不支持 flash_attention_2。自动切换到 'sdpa'。",
                UserWarning
            )
...
class Qwen2_5_VLForConditionalGenerationBlockAttention(Qwen2_5_VLForConditionalGeneration):
    
    def __init__(self, config):
        original_impl = getattr(config, '_attn_implementation', 'eager')
        if original_impl == "flash_attention_2":
            warnings.warn(
                "⚠️ Block Attention 不支持 flash_attention_2，自动切换到 'sdpa'。",
                UserWarning
            )
            config._attn_implementation = "sdpa"
        ...
        self.visual = Qwen2_5_VisionTransformerPretrainedModel._from_config(config.vision_config)
        self.model = Qwen2_5_VLBlockAttentionModel(config)
        ...
        logger.info(f"✓ Initialized Qwen2_5_VLForConditionalGenerationBlockAttention")
            ...
            if len(idx_w_image) > 0:
                ...
                if len(idx_w_image):
                    ...
                    valid_pixel_values = [
                        ...
                        else torch.from_numpy(pixel_values[i]) 
                        for i in idx_w_image
                    ]
...
__all__ = [
    ...
    "Qwen2_5_VLBidirectionalAttention",
    "Qwen2_5_VLBidirectionalFlashAttention2",
    "Qwen2_5_VLBidirectionalSdpaAttention",
    "Qwen2_5_VLBidirectionalDecoderLayer",
    "Qwen2_5_VLBidirectionalModel",
    "Qwen2_5_VLForConditionalGenerationBidirectional",
    "Qwen2_5_VLBlockAttentionModel",
    "Qwen2_5_VLForConditionalGenerationBlockAttention",
    "create_block_attention_mask",
    "create_block_attention_mask_with_multiple_eos",
]